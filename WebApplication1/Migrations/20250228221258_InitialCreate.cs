    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerType = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Regular"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CustomerType", "[CustomerType] IN ('Regular', 'VIP')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubTasks_Tasks_ToDoTaskId",
                        column: x => x.ToDoTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToDoTasksId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskCategory", x => new { x.CategoriesId, x.ToDoTasksId });
                    table.ForeignKey(
                        name: "FK_TaskCategory_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskCategory_Tasks_ToDoTasksId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskCategory_ToDoTasksId",
                table: "TaskCategory",
                column: "ToDoTasksId");
